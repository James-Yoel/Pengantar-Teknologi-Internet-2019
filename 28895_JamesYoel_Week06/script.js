function initialize(){
	...
	//menampilkan produk dalam bentuk card mengunakan fungsi renderAllProduct
...
function renderProduct(product){
	...
	itemSeller.appendChild(document.createTextNode(product.price));
	container.appendChild(document.createTextNode(itemSeller));
